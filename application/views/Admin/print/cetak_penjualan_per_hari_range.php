...
<body>
	...
	<h3 class="letter-info center" style="text-transform: uppercase;">Tanggal Awal  : <?php echo $tanggal_awal; ?></h3>
    ...
    <table  cellspacing="0" Border="1" style="width:100%;margin-top:20px;" style="font-size: 8pt;">
		<?php foreach($rekap_per_kadar as $p) :  ?>
            <tr>
                ...
                <td rowspan="2">Rp. <?php echo format_ip((float) $p->NilaiBarang / (float) $p->BeratAsli, 2, ".", ",") ?></td>
            </tr>
            <tr>
                <td>Nilai Jual</td>
