...
<body>
	<h3 class="letter-info center" style="text-transform: uppercase;">RIWAYAT BARANG MASUK</h3>
	<h3 class="letter-info center" style="text-transform: uppercase;">NAMA RAK : <?php echo $detail_rak->nama_rak; ?></h3>
    <h3 class="letter-info center" style="text-transform: uppercase;">TANGGAL : <?php echo $tanggal; ?></h3>
    <h3 class="letter-info center" style="text-transform: uppercase;">JAM TERAKHIR : <?php echo $sampai_jam; ?></h3>
