...
<div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-3">Bobot Penelitian</h4>
                ...
                <div class="modal-dialog modal-xl" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel4">Tambah Data Bobot Penelitian</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        <form action="<?php echo base_url('admin/bobot_penelitian_tambah') ?>" method="post">
                            <div class="row">
                                <div class="col mb-3">
                ...
                <div class="card-body">
                  <div class="table-responsive text-nowrap">
                    <table class="table table-bordered" style="color:#000">
                      ...
                      <tbody>
                        <?php if(count($bobot_penelitian) > 0) :  ?>
                            <?php $no = 1;foreach($bobot_penelitian as $bp) :  ?>
                                <tr>
                                    <td><?php echo $no++; ?></td>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url("admin/bobot_penelitian_ubah/".$bp->KdJenis) ?>">
                                            <button type="button" class="btn btn-icon btn-info">
                                                <span class="tf-icons bx bx-edit"></span>
                                            </button>
                                        </a>
                                        <a onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')" href="<?php echo base_url("admin/bobot_penelitian_hapus/".$bp->KdJenis) ?>">
