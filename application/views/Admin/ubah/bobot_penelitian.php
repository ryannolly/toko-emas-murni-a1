              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="form-group mb-3">
                    <form action="<?php echo base_url('admin/bobot_penelitian_ubah_aksi') ?>" method="POST">
                ...
                <div class="card-footer">
                    <a href="<?php echo base_url("admin/bobot_penelitian") ?>"><button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Batal</button></a>
