...
>
  <head>
    ...
    <title>SPK DOSEN TERBAIK || Login</title>
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">SPK DOSEN TERBAIK</span>
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form id="formAuthentication" class="mb-3" action="<?php echo base_url(); ?>" method="POST">
                <div class="mb-3">
                  <label for="email" class="form-label">Email/NIDN/Username</label>
                  <input
                    type="text"
                    class="form-control"
                    id="email"
                ...
                <div class="mb-3">
                  <label for="email" class="form-label">Login Sebagai : </label>
                  <select class="form-control" style="color:#000" name="LoginAs" id="">
